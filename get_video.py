...
for i in os.listdir(dir_path):
    ...
    video_clip = VideoFileClip('bg_video_files/bg{}.mp4'.format(random.randint(1,3))).subclip(0,length)
    final = video_clip.set_audio(audio_clip)
    final.write_videofile("final_video\output_video{}.mp4".format(j))
    os.rename("audio_files/audio{}.mp3".format(j), "audio_files/used_audio{}.mp3".format(j))
